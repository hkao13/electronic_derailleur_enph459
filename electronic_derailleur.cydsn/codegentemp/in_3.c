...
#define SetP4PinDriveMode(shift, mode)  \
    do { \
        in_3_PC =   (in_3_PC & \
                                (uint32)(~(uint32)(in_3_DRIVE_MODE_IND_MASK << (in_3_DRIVE_MODE_BITS * (shift))))) | \
                                (uint32)((uint32)(mode) << (in_3_DRIVE_MODE_BITS * (shift))); \
    } while (0)
...
{
    uint8 drVal = (uint8)(in_3_DR & (uint8)(~in_3_MASK));
    drVal = (drVal | ((uint8)(value << in_3_SHIFT) & in_3_MASK));
    in_3_DR = (uint32)drVal;
}
...
{
	SetP4PinDriveMode(in_3__0__SHIFT, mode);
}
...
{
    return (uint8)((in_3_PS & in_3_MASK) >> in_3_SHIFT);
}
...
{
    return (uint8)((in_3_DR & in_3_MASK) >> in_3_SHIFT);
}
...
/* If Interrupts Are Enabled for this Pins component */ 
    ...
    *******************************************************************************/
    ...
    {
		uint8 maskedStatus = (uint8)(in_3_INTSTAT & in_3_MASK);
		in_3_INTSTAT = maskedStatus;
        return maskedStatus >> in_3_SHIFT;
    }
