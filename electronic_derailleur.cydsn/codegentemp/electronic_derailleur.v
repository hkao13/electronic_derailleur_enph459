// ======================================================================
// electronic_derailleur.v generated from TopDesign.cysch
// 03/27/2016 at 23:34
...
module top ;
	...
	wire [3:0] tmpOE__shifter_switches_net;
	wire [3:0] tmpFB_3__shifter_switches_net;
	wire [3:0] tmpIO_3__shifter_switches_net;
	electrical [0:0] tmpSIOVREF__shifter_switches_net;
	...
	cy_psoc3_pins_v1_10
		...
		shifter_switches
		 (.oe(tmpOE__shifter_switches_net),
		  .y({4'b0}),
		  .fb({tmpFB_3__shifter_switches_net[3:0]}),
		  .io({tmpIO_3__shifter_switches_net[3:0]}),
		  .siovref(tmpSIOVREF__shifter_switches_net),
		  .interrupt({Net_82}),
	...
	assign tmpOE__shifter_switches_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{4'b1111} : {4'b1111};
    ...
    cy_annotation_universal_v1_0 shift_up_front_sw (
        .connect({
            Net_3,
            Net_90
        })
    );
    defparam shift_up_front_sw.comp_name = "SwitchSPST_v1_0";
    defparam shift_up_front_sw.port_names = "T1, T2";
    defparam shift_up_front_sw.width = 2;
    ...
    cy_annotation_universal_v1_0 shift_dn_front_sw (
        .connect({
            Net_3,
            Net_91
        })
    );
    defparam shift_dn_front_sw.comp_name = "SwitchSPST_v1_0";
    defparam shift_dn_front_sw.port_names = "T1, T2";
    defparam shift_dn_front_sw.width = 2;
	...
	wire [0:0] tmpOE__en_1_2_net;
	wire [0:0] tmpFB_0__en_1_2_net;
	wire [0:0] tmpIO_0__en_1_2_net;
	wire [0:0] tmpINTERRUPT_0__en_1_2_net;
	electrical [0:0] tmpSIOVREF__en_1_2_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		en_1_2
		 (.oe(tmpOE__en_1_2_net),
		  .y({Net_150}),
		  .fb({tmpFB_0__en_1_2_net[0:0]}),
		  .io({tmpIO_0__en_1_2_net[0:0]}),
		  .siovref(tmpSIOVREF__en_1_2_net),
		  .interrupt({tmpINTERRUPT_0__en_1_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__en_1_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__en_3_4_net;
	wire [0:0] tmpFB_0__en_3_4_net;
	wire [0:0] tmpIO_0__en_3_4_net;
	wire [0:0] tmpINTERRUPT_0__en_3_4_net;
	electrical [0:0] tmpSIOVREF__en_3_4_net;

	cy_psoc3_pins_v1_10
		#(.id("f02c955f-5189-4cbd-85b5-ec48618a0eae"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		en_3_4
		 (.oe(tmpOE__en_3_4_net),
		  .y({Net_186}),
		  .fb({tmpFB_0__en_3_4_net[0:0]}),
		  .io({tmpIO_0__en_3_4_net[0:0]}),
		  .siovref(tmpSIOVREF__en_3_4_net),
		  .interrupt({tmpINTERRUPT_0__en_3_4_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__en_3_4_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    assign Net_56 = 1'h0;

    CyControlReg_v1_80 front_motor (
        .control_1(Net_78),
        .control_2(Net_79),
        .control_3(Net_80),
        .control_0(Net_81),
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam front_motor.Bit0Mode = 0;
    defparam front_motor.Bit1Mode = 0;
    defparam front_motor.Bit2Mode = 0;
    defparam front_motor.Bit3Mode = 0;
    defparam front_motor.Bit4Mode = 0;
    defparam front_motor.Bit5Mode = 0;
    defparam front_motor.Bit6Mode = 0;
    defparam front_motor.Bit7Mode = 0;
    defparam front_motor.BitValue = 0;
    defparam front_motor.BusDisplay = 0;
    defparam front_motor.ExtrReset = 0;
    defparam front_motor.NumOutputs = 2;

    CyControlReg_v1_80 rear_motor (
        .control_1(Net_89),
        .control_2(Net_92),
        .control_3(Net_93),
        .control_0(Net_94),
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam rear_motor.Bit0Mode = 0;
    defparam rear_motor.Bit1Mode = 0;
    defparam rear_motor.Bit2Mode = 0;
    defparam rear_motor.Bit3Mode = 0;
    defparam rear_motor.Bit4Mode = 0;
    defparam rear_motor.Bit5Mode = 0;
    defparam rear_motor.Bit6Mode = 0;
    defparam rear_motor.Bit7Mode = 0;
    defparam rear_motor.BitValue = 0;
    defparam rear_motor.BusDisplay = 0;
    defparam rear_motor.ExtrReset = 0;
    defparam rear_motor.NumOutputs = 2;
	...
	cy_psoc3_pins_v1_10
		#(.id("edc0e318-1572-4841-8e3a-0b808c4c9d16"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__in_2_net;
	wire [0:0] tmpFB_0__in_2_net;
	wire [0:0] tmpIO_0__in_2_net;
	wire [0:0] tmpINTERRUPT_0__in_2_net;
	electrical [0:0] tmpSIOVREF__in_2_net;

	cy_psoc3_pins_v1_10
		#(.id("845cae69-731a-42a2-998d-87c74d3788e7"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		in_2
		 (.oe(tmpOE__in_2_net),
		  .y({Net_78}),
		  .fb({tmpFB_0__in_2_net[0:0]}),
		  .io({tmpIO_0__in_2_net[0:0]}),
		  .siovref(tmpSIOVREF__in_2_net),
		  .interrupt({tmpINTERRUPT_0__in_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__in_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__in_3_net;
	wire [0:0] tmpFB_0__in_3_net;
	wire [0:0] tmpIO_0__in_3_net;
	wire [0:0] tmpINTERRUPT_0__in_3_net;
	electrical [0:0] tmpSIOVREF__in_3_net;

	cy_psoc3_pins_v1_10
		#(.id("8b9f76fe-1a19-4b74-8a37-99f368303edc"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		in_3
		 (.oe(tmpOE__in_3_net),
		  .y({Net_94}),
		  .fb({tmpFB_0__in_3_net[0:0]}),
		  .io({tmpIO_0__in_3_net[0:0]}),
		  .siovref(tmpSIOVREF__in_3_net),
		  .interrupt({tmpINTERRUPT_0__in_3_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__in_3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__in_4_net;
	wire [0:0] tmpFB_0__in_4_net;
	wire [0:0] tmpIO_0__in_4_net;
	wire [0:0] tmpINTERRUPT_0__in_4_net;
	electrical [0:0] tmpSIOVREF__in_4_net;

	cy_psoc3_pins_v1_10
		#(.id("2382f80f-3301-49cc-a619-7c71bc2f29da"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		in_4
		 (.oe(tmpOE__in_4_net),
		  .y({Net_89}),
		  .fb({tmpFB_0__in_4_net[0:0]}),
		  .io({tmpIO_0__in_4_net[0:0]}),
		  .siovref(tmpSIOVREF__in_4_net),
		  .interrupt({tmpINTERRUPT_0__in_4_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__in_4_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__decoder_A_net;
	wire [0:0] tmpIO_0__decoder_A_net;
	wire [0:0] tmpINTERRUPT_0__decoder_A_net;
	electrical [0:0] tmpSIOVREF__decoder_A_net;

	cy_psoc3_pins_v1_10
		#(.id("941e6219-ef5f-4862-baf0-ec11b676fe88"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		decoder_A
		 (.oe(tmpOE__decoder_A_net),
		  .y({1'b0}),
		  .fb({Net_1522}),
		  .io({tmpIO_0__decoder_A_net[0:0]}),
		  .siovref(tmpSIOVREF__decoder_A_net),
		  .interrupt({tmpINTERRUPT_0__decoder_A_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__decoder_A_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__decoder_B_net;
	wire [0:0] tmpIO_0__decoder_B_net;
	wire [0:0] tmpINTERRUPT_0__decoder_B_net;
	electrical [0:0] tmpSIOVREF__decoder_B_net;

	cy_psoc3_pins_v1_10
		#(.id("1ed95c59-78e0-4507-8e06-80463be9fc83"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		decoder_B
		 (.oe(tmpOE__decoder_B_net),
		  .y({1'b0}),
		  .fb({Net_1523}),
		  .io({tmpIO_0__decoder_B_net[0:0]}),
		  .siovref(tmpSIOVREF__decoder_B_net),
		  .interrupt({tmpINTERRUPT_0__decoder_B_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__decoder_B_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    TCPWM_P4_v2_0_2 QuadDec (
        .stop(1'b0),
        .reload(1'b0),
        .start(Net_1523),
        .count(Net_1522),
    ...
    cy_annotation_universal_v1_0 shift_dn_rear_sw (
        .connect({
            Net_3,
            Net_381
        })
    );
    defparam shift_dn_rear_sw.comp_name = "SwitchSPST_v1_0";
    defparam shift_dn_rear_sw.port_names = "T1, T2";
    defparam shift_dn_rear_sw.width = 2;

    cy_annotation_universal_v1_0 shift_up_rear_sw (
        .connect({
            Net_3,
            Net_380
        })
    );
    defparam shift_up_rear_sw.comp_name = "SwitchSPST_v1_0";
    defparam shift_up_rear_sw.port_names = "T1, T2";
    defparam shift_up_rear_sw.width = 2;

	wire [0:0] tmpOE__rear_pot_feedback_net;
	wire [0:0] tmpFB_0__rear_pot_feedback_net;
	wire [0:0] tmpIO_0__rear_pot_feedback_net;
	wire [0:0] tmpINTERRUPT_0__rear_pot_feedback_net;
	electrical [0:0] tmpSIOVREF__rear_pot_feedback_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("77715107-f8d5-47e5-a629-0fb83101ac6b"),
		  ...
		  .input_buffer_sel(2'b00))
		rear_pot_feedback
		 (.oe(tmpOE__rear_pot_feedback_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__rear_pot_feedback_net[0:0]}),
		  .analog({Net_549}),
		  .io({tmpIO_0__rear_pot_feedback_net[0:0]}),
		  .siovref(tmpSIOVREF__rear_pot_feedback_net),
		  .interrupt({tmpINTERRUPT_0__rear_pot_feedback_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__rear_pot_feedback_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    ADC_SAR_SEQ_P4_v2_20_3 ADC_SAR_SEQ (
        .Vref(Net_565),
        .sdone(Net_566),
        .eoc(Net_567),
        .aclk(1'b0),
