...
# Date: Mon, 28 Mar 2016 06:34:31 GMT
#set_units -time ns
create_clock -name {quad_dec_clk(FFB)} -period 83.333333333333329 -waveform {0 41.6666666666667} [list [get_pins {ClockBlock/ff_div_7}]]
create_clock -name {ADC_SAR_SEQ_intClock(FFB)} -period 375 -waveform {0 187.5} [list [get_pins {ClockBlock/ff_div_6}]]
...
create_generated_clock -name {quad_dec_clk} -source [get_pins {ClockBlock/hfclk}] -edges {1 5 9} [list]
create_generated_clock -name {timer_clock} -source [get_pins {ClockBlock/hfclk}] -edges {1 3 5} [list [get_pins {ClockBlock/udb_div_1}]]
create_generated_clock -name {ADC_SAR_SEQ_intClock} -source [get_pins {ClockBlock/hfclk}] -edges {1 19 37} [list]
...
create_generated_clock -name {pwm_clock} -source [get_pins {ClockBlock/hfclk}] -edges {1 5 9} [list [get_pins {ClockBlock/udb_div_3}]]
